...
public class Conexion {
    private static final String SERVIDOR = "jdbc:mysql://your-ip:your-port/";
    private static final String NOMBRE_BASE_DATOS = "yourdb";
    private static final String USER = "yourName";
